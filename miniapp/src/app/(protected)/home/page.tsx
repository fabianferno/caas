    ...
    <>
      <Page.Header className="px-5 pt-6 pb-4" style={{ background: '#e0e5ec' } as React.CSSProperties}>
        <div className="flex items-center justify-between">
          <div>
            <p className="text-[11px] font-bold uppercase tracking-[0.2em] mb-0.5 gradient-text">
              Agents as a Service
            </p>
            <h1 className="font-coolvetica text-[1.9rem] uppercase leading-none tracking-tight" style={{ color: '#31456a' }}>
              CaaS
            </h1>
          </div>
          <div
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div
                      ...
                      style={{ boxShadow: 'inset 2px 2px 4px #a3b1c6, inset -2px -2px 4px #ffffff' }}
                    >
